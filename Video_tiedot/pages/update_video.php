<?php
    ...
    if(isset($_POST["videoid"]) && !empty($_POST["videoid"])) {
        ...
        if(empty($name_err) && empty($genre_err) && empty($lenght_err) && empty($age_limit_err) && empty($release_date_err) && empty($production_year_err) && empty($info_err) && empty($director_err) && empty($cast_err) && empty($picture_err)) {
            $sql = "UPDATE elokuva SET nimi=?, genre=?, kesto=?, ikaraja=?, julkaisupaiva=?, tuotantovuosi=?, kuvaus=?, ohjaaja=?, nayttelijat=?, kuva=? WHERE videoid = ".$id."";
...
<html lang="fi">
    <head>
        ...
        ?>
        <meta charset="utf-8">
        <title>Videovuokraamo - Elokuvan päivittäminen</title>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="page-header">
                            <h2>Elokuvan tietojen päivittäminen</h2>
                        </div>
                        <hr>
                        ...
                        <form action="<?php echo htmlspecialchars(basename($_SERVER['REQUEST_URI'])); ?>" method="post">
                            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                                ...
                                <div class="form-group">
                                    <label class="font-weight-bold">Elokuvan ID:</label>
                                    <input type="text" name="id" readonly class="form-control" value="<?php echo $id; ?>">
                                </div>
                                ...
                                <div class="form-group <?php echo (!empty($release_date_err)) ? 'has-error' : ''; ?>">
                                    ...
                                    <input placeholder="Kirjoita julkaisupäivä" type="text" name="release_date" class="form-control" value="<?php echo $release_date; ?>">
                                    <small class="form-text text-danger">
                                ...
                                <div class="form-group <?php echo (!empty($production_year_err)) ? 'has-error' : ''; ?>">
                                    ...
                                    <input placeholder="Kirjoita tuotantovuosi" type="text" name="production_year" class="form-control" value="<?php echo $production_year; ?>">
                                    <small class="form-text text-danger">
                                ...
                                <div class="form-group <?php echo (!empty($info_err)) ? 'has-error' : ''; ?>">
                                    ...
                                    <textarea placeholder="Kirjoita kuvaus" rows="3" type="text" name="info" class="form-control"><?php echo $info; ?></textarea>
                                    <small class="form-text text-danger">
                                        <?php echo $info_err;?>
                                    </small>
                                </div>
                                ...
                                <div class="form-group <?php echo (!empty($picture_err)) ? 'has-error' : ''; ?>">
                                    ...
                                    <input placeholder="Kirjoita kuvan osoite esim: https://imgur.com/kuva1" type="text" name="picture" class="form-control" value="<?php echo $picture; ?>">
                                    <small class="form-text text-danger">
